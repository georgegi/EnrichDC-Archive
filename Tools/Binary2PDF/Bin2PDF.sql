...
/*
	...
	Note:  When running this in SSMS set the option 
		Tools > Options > Query Results > SQL Server > Results To Grid > Discard results after execution.
	Not doing this may result in an out-of-memory error when there are over 35,000 results in the cursor query.

	Pay close attention to the syntax of the format file.  The format file cannot be in the root directory of a drive.
